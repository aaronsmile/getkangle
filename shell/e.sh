...
URL="http://github.itzmx.com/bangteng/getkangle/master/kangle/cdnbest/kangle-cdnbest-$VERSION$ARCH.tar.gz"
...
sleep 3
mkdir -p $PREFIX
wget http://github.itzmx.com/bangteng/getkangle/master/kangle/ent/license.txt -O $PREFIX/license.txt
./install.sh $PREFIX
$PREFIX/bin/kangle
