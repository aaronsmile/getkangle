...
DOWNLOAD_BASE_URL="http://github.itzmx.com/bangteng/getkangle/master/kangle";
restore_config()
{
...
function setup_pureftpd
{
	...
	del_proftpd
	DOWN_URL="ftp://ftp.pureftpd.org/pub/pure-ftpd/releases/pure-ftpd-$PUREFTP_VERSION.tar.bz2"
